...
internal class ConversionTools
{
   ...
   public static async Task<string> ConvertToGeoJson(GISBloxClient gisbloxClient,
   ...
   public static async Task<List<WKT>> ConvertToWkt(
   ...
   public static async Task<List<WKT>> ConvertToWktFromFile(
      GISBloxClient gisbloxClient,
   ...
   public static async Task<List<WKB>> ConvertToWkb(
      GISBloxClient gisbloxClient,
      [ParamDesc("The GeoJson Feature(Collection) string to convert.")]
      string geoJson,
      CancellationToken cancellationToken = default)
   ...
   public static async Task<List<WKB>> ConvertToWkbFromFile(
      GISBloxClient gisbloxClient,
      [ParamDesc("The local file path to the GeoJson file to convert.")]
      string localPath,
      CancellationToken cancellationToken = default)
