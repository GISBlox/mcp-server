...
internal class ProjectionTools
{
   ...
   [McpServerTool(Name = "projection_wgs84_to_rds_complete_get")]
   ...
   [McpServerTool(Name = "projection_wgs84_to_rds_list")]
   ...
   [McpServerTool(Name = "projection_wgs84_to_rds_complete_list")]
   ...
   [McpServerTool(Name = "projection_rds_to_wgs84_get")]
   ...
   [McpServerTool(Name = "projection_rds_to_wgs84_complete_get")]
   ...
   [McpServerTool(Name = "projection_rds_to_wgs84_list")]
   ...
   [McpServerTool(Name = "projection_rds_to_wgs84_complete_list")]
